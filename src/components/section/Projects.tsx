...
const Projects = () => {
  ...
  const projects = [
    {
      title: "Croptails",
      description: "A 2D farming simulation game built in Godot using a test-scene-first prototyping methodology. Features player state machines, tool states, Y-sorting rendering, dynamic tilemaps, and NPC navigation agents, plus full systems for inventory management, crop cultivation, day/night cycles, save data serialization, dialogue UI, and audio.",
      technologies: ["Godot Engine", "GDScript"],
      icon: comingSoon,
      detailsUrl: "/projects/croptails",
      githubUrl: socialLinks.repositories.projectOne
    },
    {
      title: "ML Emotion Detection",
      description: "A machine learning model for emotion detection and classification, built in Python.",
      technologies: ["Python", "Machine Learning"],
      icon: comingSoon,
      detailsUrl: "/projects/ml-emotion-detection",
      githubUrl: socialLinks.repositories.projectTwo
    },
    {
      title: "React 3D Art Gallery",
      description: "An interactive 3D gallery application with an immersive VR-style experience, built with React and advanced 3D rendering.",
      technologies: ["React", "Three.js"],
      icon: comingSoon,
      detailsUrl: "/projects/react-3d-art-gallery",
