...
const Croptails = lazy(() => import('./pages/projects/Croptails'))
const MlEmotionDetection = lazy(() => import('./pages/projects/MlEmotionDetection'))
const React3DArtGallery = lazy(() => import('./pages/projects/React3DArtGallery'))
        ...
        <main id="main-content" className="main-content">
          <Suspense fallback={<div className="flex items-center justify-center min-h-screen">Loading...</div>}>
            <Routes>
              ...
              {/* Project routes */}
              <Route path="/projects/croptails" element={<Croptails />} />
              <Route path="/projects/ml-emotion-detection" element={<MlEmotionDetection />} />
              <Route path="/projects/react-3d-art-gallery" element={<React3DArtGallery />} />
            </Routes>
          </Suspense>
        </main>
